    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Get help with your health journey and platform usage
        </p>
      </div>
        ...
        {supportContacts.map((contact) => (
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 rounded-lg bg-gray-50">{contact.icon}</div>
              <div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                {
                  title: "Understanding Health Reports",
                  duration: "8 min read",
                  category: "intermediate",
                },
                {
                  title: "Maximizing Wearable Integration",
                ...
                {
                  title: "Doctor Consultation Tips",
                  duration: "7 min read",
                  ...
                  <div className="p-4 bg-green-50 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-medium text-green-800">
                        Bibas lost 15kg in 3 months
                      </span>
                    </div>
                    <p className="text-sm text-green-700">
                      "Using HealthConnect transformed my health journey..."
                    </p>
                  </div>
                  <div className="p-4 bg-blue-50 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-medium text-blue-800">
                        Sarah improved sleep by 40%
                      </span>
                    </div>
                    <p className="text-sm text-blue-700">
                      "The sleep tracking feature helped me identify
                      patterns..."
                    </p>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="mt-8 p-4 bg-indigo-50 rounded-lg">
                  ...
                  <p className="text-indigo-700 text-sm">
                    ...
                    immediately. Our platform is for non-emergency health
