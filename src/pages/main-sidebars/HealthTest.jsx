    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
        ...
        <div className="flex space-x-2 pb-2">
          {testCategories.map((category) => (
            <button
              ...
              className={`flex items-center hover:cursor-pointer gap-2 px-4 py-3 rounded-lg whitespace-nowrap transition-all ${
            ...
            {test.completed ? (
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <button className="flex-1 hover:cursor-pointer border border-gray-300 text-gray-700 py-2 rounded-lg font-medium hover:bg-gray-50 transition-colors">
                    View Report
                  </button>
                  <button className="flex-1 hover:cursor-pointer border border-indigo-600 text-indigo-600 py-2 rounded-lg font-medium hover:bg-indigo-50 transition-colors">
                    Retake Test
                  </button>
                </div>
              </div>
            ) : (
              <button className="w-full hover:cursor-pointer bg-indigo-600 text-white py-3 rounded-lg font-medium hover:bg-indigo-700 transition-colors flex items-center justify-center gap-2">
                <PlayCircle size={20} />
                Start Test
              </button>
            )}
      ...
      <div className="mt-8 bg-linear-to-r from-indigo-50 to-blue-50 rounded-xl p-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <button className="bg-indigo-600 hover:cursor-pointer text-white px-6 py-3 rounded-lg font-medium hover:bg-indigo-700 transition-colors whitespace-nowrap">
