...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="fixed top-0 z-50 w-full bg-white shadow-sm border-b border-gray-200 px-3 lg:px-0 py-2 h-14">
        <div className="flex items-center justify-between h-full max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-end gap-2 flex-1">
            ...
            <Link
              to="/messages"
              className="hidden sm:flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors relative"
              aria-label="Messages"
            >
