...
export default function DoctorConsultations() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Doctor Consultations</h1>
        <p className="text-gray-600 mt-2">Book appointments with verified healthcare professionals</p>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredDoctors.map((doctor) => (
            <div key={doctor.id} className="bg-white rounded-xl p-5 shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
              <div className="flex justify-between items-start mb-4">
                ...
                {doctor.available ? (
                  ...
                  <div className="flex items-center gap-1 px-2 py-1 bg-red-50 rounded-md">
                    ...
                    <span className="text-sm font-medium text-red-700">Busy</span>
                  </div>
                )}
              </div>
            ...
            <tbody>
              {filteredAppointments.map((appointment) => (
                <tr key={appointment.id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-4 px-6 text-gray-700">{appointment.duration}</td>
                  <td className="py-4 px-6">
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${
