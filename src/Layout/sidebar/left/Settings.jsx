                      ...
                      <div key={key} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                        <div>
                          ...
                          <p className="text-sm text-gray-500 mt-1">
                            ...
                            {key === 'reminders' && 'Health reminder notifications'}
                            {key === 'healthAlerts' && 'Important health alerts'}
                            {key === 'promotional' && 'Promotional offers and updates'}
                          </p>
                        </div>
                        <button
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between p-3">
                          <div>
                            ...
                            <p className="text-sm text-gray-500">New York, USA • 1 day ago</p>
                          </div>
                          <button className="text-red-600 font-medium">Revoke</button>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-6">
                    <div className="border border-gray-200 rounded-lg p-6">
                      ...
                      <p className="text-gray-600 mb-4">Download a copy of all your health data, reports, and activity history.</p>
                      <button
                        onClick={exportData}
                    ...
                    <div className="border border-gray-200 rounded-lg p-6">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-lg font-bold text-gray-900">Import Health Data</h3>
                      </div>
                      <p className="text-gray-600 mb-4">Upload health data from other platforms or devices.</p>
                      ...
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 mt-1">Switch between light and dark themes</p>
                          </div>
                        </div>
                        <button
